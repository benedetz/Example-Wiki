...
Key Feature Designs (optional) - As new features are added, record the specific design changes that were necessary to add the feature. Useful for testing, release notes, etc.
...
What you test (unit, integration, manual checks), test data, and how to run everything. Makes quality visible and repeatable, and turns requirements into checks.
...
What data you collect, how you protect it, and any ethical risks or mitigations. Demonstrates responsible engineering, even for student projects.
